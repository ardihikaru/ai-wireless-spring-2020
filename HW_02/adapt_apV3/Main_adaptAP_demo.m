...
clear;
% id = 15;        % selecting a data set, rows - data points, columns - dimensions
...
nrun2 = 2;   % max iteration times for original AP
...
% true labels in 1st column
 ...
 % true labels being unknown (1st column is data too)
  ...
  case 15
     sw='similarity_matrix.txt'; nrow = 12; % number of samples    
